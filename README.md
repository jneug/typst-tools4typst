...
#import "@preview/t4t:0.0.0": is, def
```
...
```js
#import "@preview/t4t:0.0.0": is-none, is-auto
```
...
```js
#import "@preview/t4t:0.0.0": assert
```
...
```js
#import "@preview/t4t:0.0.0": alias
```
